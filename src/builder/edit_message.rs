...
impl EditMessage {
    ...
    ///Hide all embeds in the message, this includes those generated by Discord themselves
    /// 
    /// **Note**: This does not delete the embed, it only hides it
    pub fn suppress_embeds(&mut self, suppress: bool) -> &mut Self {

        //1 << 2 is defined by the API to be the SUPPRESS_EMBEDS flag by the discord API
        //at present the only accepted value in "flags" is the SUPPRESS_EMBEDS for editing messages
        if suppress {
