...
pub trait EventHandler {
    ...
    #[cfg(feature = "cache")]
    fn cached(&self, _ctx: &Context, _guilds: &[GuildId]) {}

    /// Dispatched when a channel is created.
    ///
    /// Provides said channel's data.
    fn channel_create(&self, _ctx: &Context, _channel: &RwLock<GuildChannel>) {}

    /// Dispatched when a category is created.
    ///
    /// Provides said category's data.
    fn category_create(&self, _ctx: &Context, _category: &RwLock<ChannelCategory>) {}

    /// Dispatched when a category is deleted.
    ///
    /// Provides said category's data.
    fn category_delete(&self, _ctx: &Context, _category: &RwLock<ChannelCategory>) {}

    /// Dispatched when a private channel is created.
    ///
    /// Provides said channel's data.
    fn private_channel_create(&self, _ctx: &Context, _channel: &RwLock<PrivateChannel>) {}

    /// Dispatched when a channel is deleted.
    ///
    /// Provides said channel's data.
    fn channel_delete(&self, _ctx: &Context, _channel: &RwLock<GuildChannel>) {}
    ...
    #[cfg(feature = "cache")]
    fn guild_delete(&self, _ctx: &Context, _incomplete: &PartialGuild, _full: Option<&RwLock<Guild>>) {}
    ...
    #[cfg(feature = "cache")]
    fn guild_update(&self, _ctx: &Context, _old_data_if_available: Option<&RwLock<Guild>>, _new_but_incomplete: &PartialGuild) {}
    ...
    fn message_delete_bulk(&self, _ctx: &Context, _channel_id: ChannelId, _multiple_deleted_messages_ids: &[MessageId]) {}
    ...
    fn presence_replace(&self, _ctx: &Context, _presences: &[Presence]) {}
    ...
    fn unknown(&self, _ctx: &Context, _name: &str, _raw: &Value) {}
    ...
    #[cfg(feature = "cache")]
    fn voice_state_update(&self, _ctx: Context, _guild_id: Option<GuildId>, _old: Option<VoiceState>, _new: &VoiceState) {}
